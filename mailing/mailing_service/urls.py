...
urlpatterns = [
    ...
    path(
        "update_recipient_views/<int:pk>/",
        views.RecipientUpdateView.as_view(),
        name="update_recipient_views",
    ),
    path(
        "detail_recipient_views/<int:pk>/",
        views.RecipientDetailView.as_view(),
        name="detail_recipient_views",
    ),
    path(
    ...
    path(
        "disable_mailing_views/<int:pk>/",
        views.DisableMailingView.as_view(),
        name="disable_mailing_views",
    ),
    path(
        "detail_mailing_views/<int:pk>/send_mail_views/",
