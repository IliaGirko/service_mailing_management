    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_mailing",
                    models.DateTimeField(verbose_name="Дата время начала рассылки"),
                ),
                (
                    "end_mailing",
                    models.DateTimeField(verbose_name="Дата время окончания рассылки"),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "permissions": [
                    ("can_view_all_recipient_lists", "can view all recipient lists")
                ],
            },
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                to="mailing_service.recipientmailing",
