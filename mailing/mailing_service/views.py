...
from .forms import MailingForm, MessageForm, RecipientMailingForm
from .models import Mailing, MailingAttempt, Message, RecipientMailing
...
class SendMailView(View):
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            mail_attempt = MailingAttempt(
                status="Не успешно", mail_server_response=e, mailing=mail
            )
            ...
            mail_attempt = MailingAttempt(
                status="Успешно", mail_server_response="Письмо доставлено", mailing=mail
            )
...
class MailingListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["total_launched_mailings"] = len(
            Mailing.objects.filter(status="Запущена")
        )
