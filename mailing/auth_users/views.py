...
from .models import CustomUser, NewPassword, ResetPassword
...
class RegisterView(CreateView):
    ...
    def form_valid(self, form):
        ...
        user.email_user(mail_subject, message, DEFAULT_FROM_EMAIL)
...
class CustomUserUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse_lazy(
            "auth_users:custom_user_detail_views", args=[self.kwargs.get("pk")]
        )
